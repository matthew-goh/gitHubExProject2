    ...
    "return a Right(User)" in {
      stubFor(get(urlEqualTo("/github/users/matthew-goh"))
        .willReturn(aResponse()
          ...
          .withBody(GithubConnectorSpec.testUserJsonStr)))
    ...
    "return a Right(Seq[RepoItem])" in {
      stubFor(get(urlEqualTo("/github/repos/matthew-goh/scala101/contents"))
        .willReturn(aResponse()
          .withStatus(200)
          .withHeader("Content-Type", "application/json")
          .withBody(GithubConnectorSpec.testRepoItemsJsonStr)))
    ...
    "return a Right(response)" in {
      stubFor(put(urlEqualTo("/github/create/matthew-goh/repos/test-repo/testfile.txt"))
        ...
        .willReturn(aResponse()
          .withStatus(201)
          .withHeader("Content-Type", "application/json")
          .withBody(GithubConnectorSpec.createResponseBody)))
      ...
      whenReady(TestGithubConnector.createUpdate(s"http://$Host:$Port/github/create/matthew-goh/repos/test-repo/testfile.txt",
        ...
        result shouldBe Right(Json.parse(GithubConnectorSpec.createResponseBody))
      }
    }
    ...
    "return a Right(response)" in {
      stubFor(delete(urlEqualTo("/github/delete/matthew-goh/repos/test-repo/testfile.txt"))
        ...
        .willReturn(aResponse()
          .withStatus(200)
          .withHeader("Content-Type", "application/json")
          .withBody(GithubConnectorSpec.deleteResponseBody)))
      ...
      whenReady(TestGithubConnector.delete(s"http://$Host:$Port/github/delete/matthew-goh/repos/test-repo/testfile.txt",
        ...
        result shouldBe Right(Json.parse(GithubConnectorSpec.deleteResponseBody))
      }
    }
...
object GithubConnectorSpec {
  ...
  val createResponseBody = """{"content":{"name":"testfile.txt","path":"testfile.txt","sha":"4753fddcf141a3798b6aed0e81f56c7f14535ed7","size":18,
...
"""
  ...
  val deleteResponseBody = """{"content":null,"commit":{"sha":"1c70ddaa5668b41bcdb78f376acd41ae3bcdc36f","node_id":"C_kwDONRSKnNoAKDFjNzBkZGFhNTY2OGI0MWJjZGI3OGYzNzZhY2Q0MWFlM2JjZGMzNmY",
